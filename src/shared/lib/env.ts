...
const envSchema = z.object({
  ...
  STRIPE_PRICE_ESSENTIAL_MONTHLY: optionalString,
  STRIPE_PRICE_ESSENTIAL_ANNUAL: optionalString,
  STRIPE_PRICE_FAMILY_MONTHLY: optionalString,
  STRIPE_PRICE_FAMILY_ANNUAL: optionalString,
